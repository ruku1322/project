  ...
  <header>
    <nav class="container">
      ...
      <div  class="d-grid gap-2 d-md-block">
        <a href="./login.php"><button class="btn btn-primary" type="button" >personal</button></a>
        <a href="./login.php"> <button class="btn btn-primary" type="button">Commercial</button></a>
      </div>
      ...
      <div class="card-group">
        ...
        <div class="card card text-bg-dark mb-3" style="max-width: 23rem;">
          ...
          <div class="d-grid gap-2 col-11 mx-auto">
            <button class="btn btn-light" type="button"  ><a href="./free.php">Start free trial</a></button>
