...
<head>
    ...
    <title>Manage Completed Action Reporting</title>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                       <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Manage Completed Action Reporting</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Completed Action Reporting Information</h6>
                        </div>
                        <div class="card-body">
