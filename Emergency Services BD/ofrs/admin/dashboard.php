                            ...
                            <div class="card border-left-danger shadow h-100 py-2">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1"> Emergency Action Requests
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                             Total Emergency Action Reportings</div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Assigned Action Requests
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
