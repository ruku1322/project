...
<html lang="en">
	<head>
	    ...
	    <title>Track Food Prices Across Bangladesh || Home Page</title>
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Real Time Price</h4>
						</div>
					</div>	
					<h6 class="text">View Real Time Prices For Any Date.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">Price Up_Down</h4>
						</div>
					</div>
					<h6 class="text">Price Up_Down Monthly and yearly.</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">Complaint Area</h4>
						</div>
					</div>
					<h6 class="text">send any product related Complaint .</h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
?>
	...
	<div class="product">		
		...
		<?php if($row['productAvailability']=='In Stock'){?>
				...
				<?php } else {?>
						<div class="action" style="color:red">No Updated Data</div>
					<?php } ?>
			</div><!-- /.product -->
