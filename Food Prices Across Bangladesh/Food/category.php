...
<html lang="en">
	<head>
	    ...
	    <title>Product Area & Category</title>
...
<div class="side-menu animate-dropdown outer-bottom-xs">
    <div class="head"><i class="icon fa fa-align-justify fa-fw"></i>Sub Area & Categories</div>        
...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container">
	            	<h3 class="section-title">For website</h3>
	            	<div class="sidebar-filter">
		            	<!-- ============================================== SIDEBAR CATEGORY ============================================== -->
<div class="sidebar-widget wow fadeInUp outer-bottom-xs ">
	<div class="widget-header m-t-20">
		<h4 class="widget-title">Area & Category</h4>
	</div>
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
								...
								<?php } else {?>
							<div class="action" style="color:red">No Update Found</div>
					<?php } ?>
