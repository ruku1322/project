...
<html lang="en">
    <head>
        ...
        <title>Track Food Prices Across Bangladesh| User Sign up</title>
        <!-- Favicon-->
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <div class="text-center text-white">
                    ...
                    <p class="lead fw-normal text-white-50 mb-0">One Time Registration is Required for view All Features</p>
                </div>
