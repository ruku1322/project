...
<html lang="en">
    <head>
        ...
        <title>Track Food Prices Across Bangladesh </title>
        <!-- Favicon-->
...
<div class="col-6">
      <table class="table">
            <thead>
                <tr>
                    <th colspan="4"><h5>Permanent Address</h5></th>
                </tr>
            </thead>
            <tr>
                <thead>
                <th width="250">Details Adresss</th>
                    <th>Division</th>
                    <th>District</th>
                    <th>Postcode</th>
                    <th>Country</th>
...
<div class="col-6">
          <table class="table">
            <thead>
                <tr>
                    <th colspan="4"><h5>Present Address</h5></th>
                </tr>
            </thead>
            <tr>
                <thead>
...
<form method="post" name="address">
     ...
     <div class="row">
        ...
        <div class="col-6">
               <div class="row">
         <div class="col-9" align="center"><h5>New Present Address</h5><br /></div>
         <hr />
     </div>
     <div class="row">
         <div class="col-3">Details Address</div>
       ...
       <div class="row mt-3">
        ...
        <div class="col-6">
               <div class="row">
         <div class="col-9" align="center"><h5>New Permanent Address</h5> 
            <input type="checkbox" name="adcheck" value="1"/>
            <small> Present Adress same as Permanent Address</small></div>
         <hr />
     </div>
     <div class="row">
         <div class="col-3">Details Address</div>
