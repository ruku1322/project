...
<div class="control-group">
<label class="control-label" for="basicinput">Product old Price </label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Product Transport Charge</label>
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Enter Product Transport Charge" class="span8 tip" required>
</div>
</div>
...
<option value="Out of Stock"> Stock</option>
</select>
</div>
</div>
